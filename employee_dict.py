    ...
    if(choice==1):
        for i in range(int(input("Enter the no of employee you want\n"))):
            ...
            if(len(str(contact))==10):
                ...
                per["january"]=int(input("Enter employees performance in JANUARY\n"))
                per["february"]=int(input("Enter employees performance in FEBRUARY\n"))
                per["march"]=int(input("Enter employees performance in MARCH\n"))
                per["april"]=int(input("Enter employees performance in APRIL\n"))
                per["may"]=int(input("Enter employees performance in MAY\n"))
                per["june"]=int(input("Enter employees performance in JUNE\n"))
                per["july"]=int(input("Enter employees performance in JULY\n"))
                per["august"]=int(input("Enter employees performance in AUGUST\n"))
                per["september"]=int(input("Enter employees performance in SEPTEMBER\n"))
                per["october"]=int(input("Enter employees performance in OCTOBER\n"))
                per["november"]=int(input("Enter employees performance in NOVEMBER\n"))
                per["december"]=int(input("Enter employees performance in DECEMBER\n"))
                emp1["performance"]=per
                emp1["salary"]=int(input("Enter the salary of Employee\n"))
                atten={}
                print("\n----Enter the attendance of all months out of 26 days----\n")
                atten["january"]=int(input("Enter employees attendance in JANUARY\n"))
                atten["february"]=int(input("Enter employees attendance in FEBRUARY\n"))
                atten["march"]=int(input("Enter employees attendance in MARCH\n"))
                atten["april"]=int(input("Enter employees attendance in APRIL\n"))
                atten["may"]=int(input("Enter employees attendance in MAY\n"))
                atten["june"]=int(input("Enter employees attendance in JUNE\n"))
                atten["july"]=int(input("Enter employees attendance in JULY\n"))
                atten["august"]=int(input("Enter employees attendance in AUGUST\n"))
                atten["september"]=int(input("Enter employees attendance in SEPTEMBER\n"))
                atten["october"]=int(input("Enter employees attendance in OCTOBER\n"))
                atten["november"]=int(input("Enter employees attendance in NOVEMBER\n"))
                atten["december"]=int(input("Enter employees attendance in DECEMBER\n"))
